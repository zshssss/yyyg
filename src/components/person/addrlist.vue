<template>
  <div class="addrlist" id="addrlist">
    <!-- 顶部标题 -->
    ...
    <div class="addrdetail_list">
        <ul>
            <li  v-for="(location, index) in userLocationInfo" :key="index">
    ...
    <div class="n_dailog_box" v-show="showDialog">
      ...
      <div class="cell" @click="showChose = !showChose">
        ...
        <img :src="baseImgUrl+'right.png'" alt="">
      </div>
      <div class="cell">
      ...
      userLocationInfo:[
        {
          name:'张某某',
          phone:'1752557577',
          location:['河南省','郑州市','管城区','黄河南路商都路']
        },
        {
          name:'王某某',
          phone:'1752557578',
          location:['河南省','郑州市','金水区','黄河路经三路']
        },
        {
          name:'李某某',
          phone:'1752557579',
          location:['河南省','郑州市','惠济区','农业路南阳路']
        }
      ],
      // 添加
...
.myAddress .cont .pic2{
  ...
  width: 0.28rem;
  height: 0.48rem;
  margin: 0.64rem 0.64rem 0.64rem 0;
}
